...
from .views import (DeviceDataPointAnimation, DeviceDataPointHeatMapSeaborn, DeviceViewSet,
                    DeviceTypeList, DeviceUserHistoryViewSet, DeviceLastPositionToday, BatchPositionCreate, DeviceLastPosition)
...
urlpatterns = [
    ...
    path('datapoints/last-position-today', DeviceLastPositionToday.as_view(), name='device-last-position-today'),
